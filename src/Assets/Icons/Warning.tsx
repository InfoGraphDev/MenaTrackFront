...
function WarningSvg({ style }:Props) {
  return (
    <svg viewBox="64 64 896 896" focusable="false" color='rgb(250, 173, 20)' data-icon="warning" style={style} width="8rem" height="8rem" fill="currentColor" aria-hidden="true">
